...
public class RobotApp extends JFrame implements ActionListener {
    ...
    private JLabel[][] board; // 2D array of labels. Displays either P for player,
                              // # for robot, or empty space
    ...
    public void createGame() { 
        ...
        // Construct list of Robot objects
        robots = new RobotList(player, width, height);
    ...
    public void drawBoard() {
        ...
        // For each location, ask the RobotList whether there is an unexploded 
        // robot there. 
        for (int y = 0; y < height; y++) {
            for (int x = 0; x < width; x++) {
                if (robots.isRobot(x, y)) {
                    board[y][x].setText("#");
                }
            }
        }
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        // Move the robots. Also invoke method for randomly generating new robot.
        robots.moveAll();
        robots.randomGenerate();
